...
#  define POLYBENCH_1D_ARRAY_DECL(var, type, dim1, ddim1) \
  type var[POLYBENCH_C99_SELECT(dim1, ddim1)];

#  define POLYBENCH_2D_ARRAY_DECL(var, type, dim1, dim2, ddim1, ddim2) \
  type var[POLYBENCH_C99_SELECT(dim1, ddim1)][POLYBENCH_C99_SELECT(dim2, ddim2)];

#  define POLYBENCH_3D_ARRAY_DECL(var, type, dim1, dim2, dim3, ddim1, ddim2, ddim3) \
  type var[POLYBENCH_C99_SELECT(dim1, ddim1)][POLYBENCH_C99_SELECT(dim2, ddim2)][POLYBENCH_C99_SELECT(dim3, ddim3)];

#  define POLYBENCH_4D_ARRAY_DECL(var, type, dim1, dim2, dim3, dim4, ddim1, ddim2, ddim3, ddim4) \
  type var[POLYBENCH_C99_SELECT(dim1, ddim1)][POLYBENCH_C99_SELECT(dim2, ddim2)][POLYBENCH_C99_SELECT(dim3, ddim3)][POLYBENCH_C99_SELECT(dim4, ddim4)];

#  define POLYBENCH_5D_ARRAY_DECL(var, type, dim1, dim2, dim3, dim4, dim5, ddim1, ddim2, ddim3, ddim4, ddim5) \
  type var[POLYBENCH_C99_SELECT(dim1, ddim1)][POLYBENCH_C99_SELECT(dim2, ddim2)][POLYBENCH_C99_SELECT(dim3, ddim3)][POLYBENCH_C99_SELECT(dim4, ddim4)][POLYBENCH_C99_SELECT(dim5, ddim5)];
# else
#  define POLYBENCH_1D_ARRAY_DECL(var, type, dim1, ddim1)		\
