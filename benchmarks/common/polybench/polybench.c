...
{
  printf("FLUSH CACHES(does nothing)");
  /*
...
void grow_alloc_table()
{
  if (_polybench_alloc_table == NULL ||
      ...
      _polybench_alloc_table->nb_avail_entries != 0)
    {
      ...
      printf("[ERROR] Inter-array padding requires to use polybench_alloc_data and polybench_free_data\n");
      exit (1);
    }
